...
function Step1SetUp({onStart}) {
    ...
    const handleUploadResume = async() => {
        if(!resumeFile || analyzing) resumeFile;
        setAnalyzing(true)
        ...
        <div className='space-y-5'>
            {
                [
                   { 
                    icon: <FaUserTie className='tex-green-600 text-xl ' />,
                    text: "Choose Role & Experience",
                   },
                   { 
                    icon: <FaMicrophoneAlt className='tex-green-600 text-xl ' />,
                    text: "Smart Voice Interview",
                   },
                   { 
                    icon: <FaChartLine className='tex-green-600 text-xl ' />,
