...
function Step2Interview({interviewData, onFinish}) {
  ...
  const [voiceGender, setVoiceGneder] = useState("female");
  ...
  useEffect(()=>{
    const loadVoices = () =>{
      ...
      if(femaleVoice){
        ...
        setVoiceGneder("female");
        return;
      }

      const maleVoice =
      voices.find(v => 
        v.name.toLowerCase().includes("Ram") ||
  ...
  useEffect(()=>{
    ...
    recognition.onresult = (event)=>{
      ...
      setAnswer((perv)=> perv + " " + transcript);
    };
          ...
          {/* text section */}
            <div className='flex-1 flex flex-col p-4 sm:p-6 md:p-8 relative'>
             ...
             {!isIntroPhase && (<div className='relative mb-6 bg-gray-50 p-4 sm:p-6 rounded-2xl border border-gray-200 shadow-sm'>
              ...
              value={answer}
              className="flex-1 bg-gray-100 p-4 sm:p-6 rounded-2xl resize-2xl resize-none outline-none border border-gray-200 focus:ring-2 focus:ring-emerald-500 transition text-gray-800"
              />
