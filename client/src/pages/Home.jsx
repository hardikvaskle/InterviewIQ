      ...
      <div className='flex-1 px-6 py-20'>
        ...
        <div className='flex justify-center mb-6'>
         ...
         <div className='text-center mb-28'>
            ...
            Role-based mock interviews with smart follow-ups, adaptive difficulty and real-time performace evaluation.
            </motion.p>
          ...
          whileTap = {{opacity:1, scale:0.98}}
           className='bg-black text-white px-10 py-3 rounded-full hover:opacity-90 transition shadow-md' >
            ...
            onClick={()=>{
             ...
             whileHover = {{opacity:0.5, scale:1.03}}
          whileTap = {{opacity:1, scale:0.98}}
           className='border border-gray-300 px-10 py-3 rounded-full hover:bg-gray-100 transiton' >
              View History
            </motion.button>
