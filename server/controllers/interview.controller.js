...
export const generateQuestion = async (req,res)=>{
    ...
    if(questionArray.length === 0){
       ...
       return res.status(500).json({
            messages:"AI failed to generate question."
        });
    }
    ...
    res.json({
        ...
        return res.status(500).json({messages:`failed to create interview ${error}`})
    }
}
...
`
    ...
    return res.status(200).json({feedback : parsed.feedback})
        ...
        return res.status(500).json({messages:`failed to submit answer ${error}`})
    }
}
 ...
 export const finishInterview = async (req,res) => {
   ...
   export const getMyInterviews = async(req,res)=>{
    try {
        ...
        return res.status(500).json({messages:`failed to find currentUser Interview ${error}`})
   ...
   export const getInterviewReport = async (req,res) => {
    try {
        ...
        return res.status(500).json({messages:`failed to find currentUser Interview report ${error}`})
    }
   }